...
class Genre(models.Model):
    ...
    """
    name = models.TextField(max_length=200, help_text="Ingrese el nombre del género (p. ej. Ciencia Ficción, Poesía Francesa etc.)",null=True)
...
class BookInstance(models.Model):
    id = models.UUIDField(primary_key=True, default=uuid4, help_text="ID único para este libro particular en toda la biblioteca")
